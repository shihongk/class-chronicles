...
//   S17 ✅ JSON
//   S18 ✅ JSON
//   All 18 scenarios migrated ✅
// =============================================================================

// All 18 scenarios are now migrated to JSON — legacy import no longer needed

// Fetch migrated scenarios from JSON
const [s1Response, s2Response, s3Response, s4Response, s5Response, s6Response, s7Response, s8Response, s9Response, s10Response, s11Response, s12Response, s13Response, s14Response, s15Response, s16Response, s17Response, s18Response] = await Promise.all([
...
console.log('[scenarios/index.js] Loaded from JSON:', s1.id, s2.id, s3.id, s4.id, s5.id, s6.id, s7.id, s8.id, s9.id, s10.id, s11.id, s12.id, s13.id, s14.id, s15.id, s16.id, s17.id, s18.id);

// All 18 scenarios migrated — no legacy scenarios remain
export const scenarios = [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18];
